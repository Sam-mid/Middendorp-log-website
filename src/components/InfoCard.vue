  ...
  <section>
    ...
    <div class="max-w-[1600px] mx-auto">
      ...
      <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <img :src="card.img" :alt="card.title" class="h-48 w-full object-cover" />
          <div class="p-6 flex flex-col flex-grow">
            <h3 class="text-xl font-bold mb-3 text-middendorp_darkgreen">{{ card.title }}</h3>
